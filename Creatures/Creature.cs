...
namespace SAIYA.Creatures
{
    ...
    {
        public override string Name => "Daybreak";
    ...
    {
        public override string Name => "Eyezor";
    ...
    {
        public override string Name => "Floofert";
    ...
    {
        public override string Name => "Gleap";
    ...
    {
        public override string Name => "Ignit";
    ...
    {
        public override string Name => "Magmalean";
    ...
    {
        public override string Name => "Mooshie";
    ...
    {
        public override string Name => "Obby";
    ...
    {
        public override string Name => "Obpod";
    ...
    {
        public override string Name => "Pebleer";
    ...
    {
        public override string Name => "Pyra";
    ...
    {
        public override string Name => "Scorchfin";
    ...
    {
        public override string Name => "Skylin";
    ...
    {
        public override string Name => "Smold";
    ...
    {
        public override string Name => "Thermaline";
